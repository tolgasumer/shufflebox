  ...
  constructor(props) {
    playlists = [
      ...
      },
      {
        ...
        "playlistname": "Türküler",
        "image": { "url": "https://shoutem.github.io/static/getting-started/restaurant-2.jpg" },
        "id": "6T04IwPTJbj2UWj0HiGNhp",
        "similarity": false
      },
      {
      ...
      <View>
        ...
        >
          <Tile>
            ...
            <Subtitle styleName="sm-gutter-horizontal">{restaurant.playlistname}</Subtitle>
            <Progress.Circle size={80} indeterminate={false} progress={restaurant.similarity / 100} showsText={true} animated={false} thickness={7} textStyle={{
              color: 'white',
              fontSize: 21, 
              fontWeight: 'bold'
            }} />
